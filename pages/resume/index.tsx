  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Full-Stack Engineer specializing in banking and financial systems (Go, React, Android) across BRILink Mobile Go, BNS, and QLola/QCash. Creator of Methora (Universal Autonomous Operating Intelligence)."
        />
